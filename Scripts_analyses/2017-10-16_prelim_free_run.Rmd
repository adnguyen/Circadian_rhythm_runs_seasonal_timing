...
#modwt plots
plot(modwt.1@V$V1[,1],modwt.1@W$W1[,1])
plot(modwt.1@V$V2[,1],modwt.1@W$W2[,1])

plot(modwt.1@V$V2[,1],modwt.1@W$W2[,1])

##plotting transformation
plot(modwt.1@series[,2],modwt.1@W$W2[,1],type="l",ylim=c(-20,70))
#lines(co1.3.1$cont_time,co1.3.1$counts,col="red")
lines(modwt.1@series[,2],modwt.1@V$V2[,1],col="purple")
