...
summary(mod)
ggplot(data=haw,aes(x=experiment,y=V1))+geom_boxplot()+ylim(0,30)
...
DJt_circ <- wavMRDSum(test$counts15,levels=4 ,keep.smooth=FALSE, keep.details=TRUE,reflect=TRUE,wavelet="s12",xform="modwt")
