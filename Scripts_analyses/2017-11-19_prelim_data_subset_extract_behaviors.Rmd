...
ggplot(test10.merg,aes(x=organism,y=circ_time))+geom_boxplot()


ggplot(test10.merg,aes(y=eclosion_days,x=V1,colour=organism))+geom_point()+stat_smooth(method="lm")

ggplot(test10.merg,aes(y=eclosion_days,x=circ_time,colour=paste(experiment,organism)))+geom_point()+stat_smooth(method="lm")

ggplot(test10.merg,aes(x=experiment,y=circ_time,group=uniqueID,colour=Host))+geom_point()+geom_line()

ggplot(test10.merg,aes(x=experiment,y=circ_time))+geom_boxplot()
...
ggplot(test4,aes(x=mid_time/4/24,y=bout))+geom_line()+geom_point(size=3)+facet_wrap(~uniqueID,ncol=2)
...
ggplot(test4.2,aes(x=mid_time/4/24,y=bout,colour=uniqueID))+geom_line()
#test5<-ddply(nall.data15_3,.(uniqueID,experiment),function(sub) dwa(sub$counts))
#test5
```
