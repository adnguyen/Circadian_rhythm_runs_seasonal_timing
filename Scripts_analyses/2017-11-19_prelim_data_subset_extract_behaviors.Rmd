...
raw.spec1<-spec.pgram(counts15$counts15,taper=0,kernel=c(4),spans=4,detrend=TRUE,log="no")
...
#1hr bin
raw.spec2<-spec.pgram(counts60$counts60,taper=0.1,,kernel=c(5,5,5),spans=15,detrend=TRUE,demean=TRUE)
